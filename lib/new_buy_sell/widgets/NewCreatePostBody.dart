...
class NewCreatePostBody extends StatefulWidget {
  ...
  @override
  _NewCreatePostBodyState createState() => _NewCreatePostBodyState();
}

class _NewCreatePostBodyState extends State<NewCreatePostBody> {
