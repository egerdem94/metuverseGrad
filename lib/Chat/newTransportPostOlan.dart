...
class TransportationCreatePostBody extends StatefulWidget {
  ...
  final TextEditingController
      availablePersonController; // = TextEditingController();
  ...
  TransportationCreatePostBody({
    ...
    required this.editOrCreate,
  }) : super();

  @override
  _TransportationCreatePostBodyState createState() =>
      _TransportationCreatePostBodyState();
}
...
class _TransportationCreatePostBodyState
  ...
  Future _sendPostToBackend() async {
    var booleanRequestResponse = await createEditPostBackEnd.sendPostToBackend(
        selectedDeparture:
            TransportationLocations.getIndexOfLocation(_selectedDeparture)
                .toString(),
        selectedDestination:
            TransportationLocations.getIndexOfLocation(_selectedDestination)
                .toString(),
    ...
    if (booleanRequestResponse == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(widget.editOrCreate == 'c'
            ? "Post create failed."
            : "Post update failed."),
      ));
    }
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          height: 50.0,
                          decoration:
                              GeneralUtil.transportationCreateBoxDecoration(),
                          child: Padding(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: DropdownButton<String>(
                                    items: TransportationLocations.locationList
