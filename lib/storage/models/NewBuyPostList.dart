...
class NewBuyPostList {
  List<NewBuyPost>? items;
  int? total;

  NewBuyPostList({this.items, this.total});

  NewBuyPostList.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
      items = <NewBuyPost>[];
      json['items'].forEach((v) {
        items!.add(new NewBuyPost.fromJson(v));
      });
    }
    total = json['total'];
  }
...
class NewBuyPost {
  ...
  NewBuyPost.fromJson(Map<String, dynamic> json) {
